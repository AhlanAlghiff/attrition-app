...
def get_model():
    uri_artifacts = "https://dagshub.com/ahlanalghiff/attrition-app.mlflow"
    mlflow.set_tracking_uri(uri_artifacts)
    model_uri = "models:/rf_model/1"
    model = mlflow.sklearn.load_model(model_uri)
    joblib.dump(model, "model/rf_attrition_model.pkl")
    return model
...
def load_model():
    MODEL_PATH = "model/rf_attrition_model.pkl"
    try:
